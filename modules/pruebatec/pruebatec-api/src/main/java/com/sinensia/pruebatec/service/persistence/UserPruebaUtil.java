...
/**
 * The persistence utility for the user prueba service. This utility wraps <code>com.sinensia.pruebatec.service.persistence.impl.UserPruebaPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see UserPruebaPersistence
 * @generated
 */
public class UserPruebaUtil {
	 ...
	 */
	public static void clearCache(UserPrueba userPrueba) {
		getPersistence().clearCache(userPrueba);
	}
	 ...
	 */
	public static Map<Serializable, UserPrueba> fetchByPrimaryKeys(
	 ...
	 */
	public static List<UserPrueba> findWithDynamicQuery(
	 ...
	 */
	public static UserPrueba update(UserPrueba userPrueba) {
		return getPersistence().update(userPrueba);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static UserPrueba update(
		UserPrueba userPrueba, ServiceContext serviceContext) {

		return getPersistence().update(userPrueba, serviceContext);
	}
	 ...
	 */
	public static List<UserPrueba> findByUuid(String uuid) {
	 ...
	 */
	public static List<UserPrueba> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<UserPrueba> findByUuid(
	 ...
	 */
	public static UserPrueba findByUuid_First(
			String uuid, OrderByComparator<UserPrueba> orderByComparator)
		throws com.sinensia.pruebatec.exception.NoSuchUserPruebaException {
	 ...
	 */
	public static UserPrueba fetchByUuid_First(
		String uuid, OrderByComparator<UserPrueba> orderByComparator) {
	 ...
	 * @throws NoSuchUserPruebaException if a matching user prueba could not be found
	 */
	public static UserPrueba findByUuid_Last(
			String uuid, OrderByComparator<UserPrueba> orderByComparator)
		throws com.sinensia.pruebatec.exception.NoSuchUserPruebaException {
	 ...
	 */
	public static UserPrueba fetchByUuid_Last(
		String uuid, OrderByComparator<UserPrueba> orderByComparator) {
	 ...
	 */
	public static UserPrueba[] findByUuid_PrevAndNext(
	 ...
	 */
	public static void cacheResult(UserPrueba userPrueba) {
		getPersistence().cacheResult(userPrueba);
	}
	 ...
	 */
	public static void cacheResult(List<UserPrueba> userPruebas) {
		getPersistence().cacheResult(userPruebas);
	}
	 ...
	 */
	public static UserPrueba create(long userId) {
	 ...
	 * @throws NoSuchUserPruebaException if a user prueba with the primary key could not be found
	 */
	public static UserPrueba remove(long userId)
		throws com.sinensia.pruebatec.exception.NoSuchUserPruebaException {

		return getPersistence().remove(userId);
	}

	public static UserPrueba updateImpl(UserPrueba userPrueba) {
		return getPersistence().updateImpl(userPrueba);
	}
	 ...
	 * @throws NoSuchUserPruebaException if a user prueba with the primary key could not be found
	 */
	public static UserPrueba findByPrimaryKey(long userId)
		throws com.sinensia.pruebatec.exception.NoSuchUserPruebaException {
	 ...
	 */
	public static UserPrueba fetchByPrimaryKey(long userId) {
	 ...
	 */
	public static List<UserPrueba> findAll() {
	 ...
	 */
	public static List<UserPrueba> findAll(int start, int end) {
	...
	public static UserPruebaPersistence getPersistence() {
		return _persistence;
	}

	private static volatile UserPruebaPersistence _persistence;
