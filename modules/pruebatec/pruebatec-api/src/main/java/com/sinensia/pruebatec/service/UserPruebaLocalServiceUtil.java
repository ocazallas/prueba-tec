...
/**
 * Provides the local service utility for UserPrueba. This utility wraps
 * <code>com.sinensia.pruebatec.service.impl.UserPruebaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserPruebaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.sinensia.pruebatec.service.impl.UserPruebaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static UserPrueba addUserPrueba(UserPrueba userPrueba) {
		return getService().addUserPrueba(userPrueba);
	}
	 ...
	 */
	public static UserPrueba createUserPrueba(long userId) {
		return getService().createUserPrueba(userId);
	}
	 ...
	 */
	public static UserPrueba deleteUserPrueba(long userId)
		throws PortalException {

		return getService().deleteUserPrueba(userId);
	}
	 ...
	 * @return the user prueba that was removed
	 */
	public static UserPrueba deleteUserPrueba(UserPrueba userPrueba) {
		return getService().deleteUserPrueba(userPrueba);
	}
	...
	public static UserPrueba fetchUserPrueba(long userId) {
		return getService().fetchUserPrueba(userId);
	}
	 ...
	 * @throws PortalException if a user prueba with the primary key could not be found
	 */
	public static UserPrueba getUserPrueba(long userId) throws PortalException {
		return getService().getUserPrueba(userId);
	}
	 ...
	 */
	public static List<UserPrueba> getUserPruebas(int start, int end) {
		return getService().getUserPruebas(start, end);
	}
	 ...
	 */
	public static int getUserPruebasCount() {
		return getService().getUserPruebasCount();
	}
	 ...
	 */
	public static UserPrueba updateUserPrueba(UserPrueba userPrueba) {
		return getService().updateUserPrueba(userPrueba);
	}

	public static UserPruebaLocalService getService() {
		return _service;
	}

	private static volatile UserPruebaLocalService _service;
