...
/**
 * Provides the local service interface for UserPrueba. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserPruebaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserPruebaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.sinensia.pruebatec.service.impl.UserPruebaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user prueba local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserPruebaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UserPrueba addUserPrueba(UserPrueba userPrueba);
	...
	public UserPrueba createUserPrueba(long userId);
	...
	public UserPrueba deleteUserPrueba(long userId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserPrueba deleteUserPrueba(UserPrueba userPrueba);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserPrueba fetchUserPrueba(long userId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserPrueba getUserPrueba(long userId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserPrueba> getUserPruebas(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserPrueba updateUserPrueba(UserPrueba userPrueba);
